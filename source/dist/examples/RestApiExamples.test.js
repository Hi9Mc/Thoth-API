...
const RestApiExamples_1 = require("./RestApiExamples");
describe('RestApiExamples', () => {
    let router;
    beforeEach(() => {
        router = new RestApiExamples_1.HttpRouter();
    });
    describe('HttpRouter', () => {
    ...
    describe('demonstrateRestApi', () => {
        it('should run without errors', async () => {
            ...
            console.log = jest.fn();
            await expect((0, RestApiExamples_1.demonstrateRestApi)()).resolves.not.toThrow();
