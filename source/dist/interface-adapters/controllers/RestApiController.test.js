...
const RestApiController_1 = require("./RestApiController");
describe('RestApiController', () => {
    ...
    beforeEach(() => {
        ...
        controller = new RestApiController_1.RestApiController(mockUseCase);
    });
    ...
    describe('Search endpoints', () => {
        it('should search resources by tenant and type', async () => {
            ...
            expect(mockUseCase.searchObjects).toHaveBeenCalledWith(expect.objectContaining({
                logic: 'AND',
    ...
    describe('Version handling', () => {
        it('should use default version 1 when not specified', async () => {
            ...
            expect(mockUseCase.getObject).toHaveBeenCalledWith(expect.objectContaining({ version: 1 }));
        });
        it('should use version from request body when provided', async () => {
            ...
            expect(mockUseCase.createObject).toHaveBeenCalledWith(expect.objectContaining({ version: 3 }));
        });
    });
